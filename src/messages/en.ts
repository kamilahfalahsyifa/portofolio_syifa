export default {
  ...
  hero: {
    ...
    intro: "Hi, I'm a Mobile Developer and UI/UX Designer focused on building scalable digital products.",
    badges: {
    ...
    items: [
      {
        ...
        year: "2025",
        description: "National finalist in the UX Design division.",
      ...
      },
      {
        ...
        year: "2024",
        description: "Completed mobile application development training.",
      ...
      },
      {
        ...
        year: "2024",
        description: "Completed Laravel web development training.",
      ...
      },
      {
        ...
        year: "2024",
        description: "User interface and user experience design certifications.",
