  ...
  return (
    ...
    >
      <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/" className="font-semibold text-[#1D1D1F] hover:text-[#0071E3] transition-colors">
          Kamilah Falah Syifa
        </Link>
        <div className="hidden md:flex items-center gap-8">
          <a href="#home" className="text-sm font-medium text-[#6E6E73] hover:text-[#1D1D1F] transition-colors">
            {t("nav.home")}
          </a>
